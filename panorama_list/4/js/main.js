...
var camera,
        ...
        onPointerDownLon,
        onPointerDownLat,
        fov = 45, // Field of View (default 70)
...
var texture = THREE.ImageUtils.loadTexture('img/spherical_texture4.jpg', new THREE.UVMapping(), function() {
    init();
    animate();
});
...
button.addEventListener('click', function() {
    THREE.ImageUtils.loadTexture('img/spherical_texture6.jpg', new THREE.UVMapping(), function() {
    	init();
    	animate();
    });
});
